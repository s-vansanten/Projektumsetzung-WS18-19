...
<form action="stundenplan_upload.php" method="post" enctype="multipart/form-data">
    ...
    <div style="font-size: 1.2em" >
      <form action="stundenplan_upload.php" method="get" name="timetable">
        <fieldset >
